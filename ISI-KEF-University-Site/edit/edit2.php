...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        ...
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block"
          href="http://localhost/gptestt/Gp/enseignant.php">User
          profile</a>

        <!-- User -->
        <ul class="navbar-nav align-items-center d-none d-md-flex">
          <li class="nav-item dropdown">
            <a class="nav-link pr-0" href="http://localhost/gptestt/Gp/Enseignant.php" role="button"
    ...
    <!-- Page content -->
    <form action="edit2_image.php" method="POST" enctype="multipart/form-data">
              ...
              <div class="card-body pt-0 pt-md-4">
                ...
                <center><button type="submit" class="btn btn-info">Update Profile Picture</button>
                  ...
                  <div class="text-center">
                    <h3>
                      <?php echo $prenom . ' ' . $nom ?><span class="font-weight-light">, <?php echo $grade ?></span>
        ...
        <div class="pl-lg-4">
          <div class="row">
            ...
            <div class="col-lg-6">
              ...
              <div class="form-group focused">
                <label class="form-control-label" for="input-first-name">Grade</label>
                <input type="text" id="input-first-name" class="form-control form-control-alternative"
                  placeholder="Votre Grade" name="grade" value="<?php echo $grade ?>">
              </div>
            ...
            <div class="col-lg-6">
              ...
              <div class="form-group">
                ...
                <input type="email" id="input-email" class="form-control
                            form-control-alternative" placeholder="@email.com" value="<?php echo $email ?>"
                  name="email">
              </div>
