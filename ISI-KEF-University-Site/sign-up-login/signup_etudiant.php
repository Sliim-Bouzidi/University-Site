...
$check_sql = "SELECT COUNT(*) as count FROM Etudiant WHERE CIN='$cin' OR Email='$email'";
...
$sql = "INSERT INTO Etudiant (CIN, Nom, Prenom, Email, Password, Classe, Image) VALUES ('$cin', '$nom', '$prenom', '$email', '$pass', '$classe', '$image')";

if (mysqli_query($conn, $sql)) {
  // Insert the CIN into the "etudiant_about" table with a null "aboutme" field
  $aboutme = null;
  $insert_sql = "INSERT INTO Etudiant_about (CIN, aboutme) VALUES ('$cin', '$aboutme')";
